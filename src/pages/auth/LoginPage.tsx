...
export default function LoginPage() {
  ...
  const [idReadOnly, setIdReadOnly] = useState(true)
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  key={tab.id}
                  type="button"
                  onClick={() => { setActiveTab(tab.id); setServerError(''); reset({ identifier: '', password: '' }); setIdReadOnly(true); setPwdReadOnly(true) }}
